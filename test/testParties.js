  ...
  describe('/parties/{party_id} for "persons"', function () {
    ...
    describe('PUT', function () {
      ...
      it('should disallow the creation of duplicates (login,alias)', function (done) {
        var testPartyPermaLink = common.hrefs.PARTIES + '/' + common.generateUUID();
        entityStore.push({permalink: testPartyPermaLink,
          login: testReferenceParty.login, password: testReferenceParty.password});
        return doPut(testPartyPermaLink, testReferenceParty, anna.login, anna.password)
